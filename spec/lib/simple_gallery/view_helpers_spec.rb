...
describe SimpleGallery::ViewHelpers, type: :helper do
  ...
  describe '#render_gallery' do
    let(:expected) { '<ul><li><a href="0-full.png" rel="simple_gallery"><img alt="0 thumb" src="/images/0-thumb.png" /></a></li><li><a href="1-full.png" rel="simple_gallery"><img alt="1 thumb" src="/images/1-thumb.png" /></a></li></ul>' }
